...
const PITCH_DECK_FRAMEWORK: DocumentFramework = {
  ...
  sections: [
    ...
    { order: 3, slideType: SlideType.MARKET_OPPORTUNITY, label: 'Market', required: true },
    {
      ...
      required: true,
      alternates: [SlideType.REVENUE_MODEL, SlideType.PRICING],
    },
...
const BOARD_DECK_FRAMEWORK: DocumentFramework = {
  ...
  sections: [
    {
      order: 1,
      slideType: SlideType.EXECUTIVE_SUMMARY,
    ...
    },
    {
      ...
      label: 'KPI Review',
      required: true,
      alternates: [SlideType.BUSINESS_MODEL],
    },
    ...
    {
      order: 5,
      slideType: SlideType.ROADMAP,
      label: 'Milestones',
      required: true,
      alternates: [SlideType.ROADMAP],
    },
    {
      order: 6,
      slideType: SlideType.ASK,
      label: 'Decisions Required',
      required: true,
      alternates: [SlideType.ASK],
    },
  ],
...
const SALES_DECK_FRAMEWORK: DocumentFramework = {
  ...
  sections: [
    { order: 1, slideType: SlideType.PROBLEM, label: 'Pain Point', required: true },
    {
      ...
      label: 'Current State',
      required: false,
      alternates: [SlideType.PROBLEM],
    },
    { order: 3, slideType: SlideType.SOLUTION, label: 'Solution', required: true },
    {
      order: 4,
      slideType: SlideType.PRODUCT_FEATURES,
      label: 'Benefits',
      required: true,
      alternates: [SlideType.SOLUTION],
    },
    {
      order: 5,
      slideType: SlideType.TRACTION,
      label: 'ROI Proof',
      required: true,
      alternates: [SlideType.CASE_STUDY],
    },
...
const STRATEGY_FRAMEWORK: DocumentFramework = {
  ...
  sections: [
    ...
    {
      order: 3,
      slideType: SlideType.VISION,
      label: 'Strategic Priorities',
      required: true,
      alternates: [SlideType.EXECUTIVE_SUMMARY],
    },
    {
      order: 4,
      slideType: SlideType.GO_TO_MARKET,
      label: 'Initiatives',
      required: true,
      alternates: [SlideType.ROADMAP],
    },
...
const PARTNERSHIP_FRAMEWORK: DocumentFramework = {
  ...
  sections: [
    ...
    {
      order: 3,
      slideType: SlideType.MARKET_OPPORTUNITY,

...
/** The 20 families the registry must cover. Mirrors composition family ids. */
...
export const SMART_USE_CASES: SmartUseCase[] = [
  'Business',
  'Investor',
  'Sales',
  'Board',
...
export const SMART_TYPE_USE_CASE: Record<SmartComponentType, SmartUseCase> = {
  ...
  teamCard: 'Investor',
  teamGrid: 'Investor',
  roadmapBlock: 'Strategy',
  timelineBlock: 'Strategy',
  featureCard: 'Marketing',
  featureGrid: 'Marketing',
  comparisonMatrix: 'Strategy',
  swotBlock: 'Strategy',
  processFlow: 'Strategy',
  quoteCard: 'Marketing',
  testimonialCard: 'Marketing',
  fundingBlock: 'Investor',
  marketOpportunity: 'Investor',
  tamSamSom: 'Investor',
  riskMatrix: 'Board',
  // Tier 6
  coverCard: 'Marketing',

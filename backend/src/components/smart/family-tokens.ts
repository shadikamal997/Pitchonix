...
const FAMILIES: Record<SmartFamilyId, FamilyTokens> = {
  ...
  'luxury-dark': {
    ...
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 700, fontWeightBody: 300,
  ...
  'startup-gradient': {
    ...
    border: 'rgba(56,189,248,0.3)', divider: 'rgba(255,255,255,0.1)',
  ...
  'ocean-deep': {
    ...
    bg: '#0c1524', surface: '#162236',
    border: 'rgba(14,165,233,0.22)', divider: 'rgba(255,255,255,0.06)',
    ...
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 700, fontWeightBody: 400,
    spacing: 1.05, numberLetterSpacing: -0.5,
    labelTransform: 'uppercase',
    mood: 'financial', isDark: true,
  },

  'forest-executive': {
    accent: '#22c55e', accent2: '#86efac',
    text: '#f0fdf4', muted: '#86efac',
    bg: '#071510', surface: '#0f2118',
    border: 'rgba(34,197,94,0.25)', divider: 'rgba(34,197,94,0.08)',
    ...
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 700, fontWeightBody: 400,
    spacing: 1.1, numberLetterSpacing: -0.5,
    labelTransform: 'uppercase',
    mood: 'executive', isDark: true,
  },
  ...
  'ember-orange': {
    ...
    border: 'rgba(255,255,255,0.28)', divider: 'rgba(255,255,255,0.12)',
    positive: '#bbf7d0', negative: '#fca5a5',
    radius: 14, strokeWidth: 1,
    shadow: '0 8px 28px rgba(249,115,22,0.42)',
    fontHeading: 'Inter, system-ui, sans-serif',
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 800, fontWeightBody: 500,
    spacing: 1.05, numberLetterSpacing: -0.8,
    labelTransform: 'none',
    mood: 'energetic', isDark: true,
  },

  'arctic-white': {
    accent: '#334155', accent2: '#475569',
    text: '#0f172a', muted: '#64748b',
    bg: '#ffffff', surface: '#f8fafc',
    border: '#e2e8f0', divider: '#f1f5f9',
    positive: '#166534', negative: '#991b1b',
    radius: 0, strokeWidth: 1.5,
    shadow: 'none',
    fontHeading: 'Inter, system-ui, sans-serif',
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 600, fontWeightBody: 400,
    spacing: 1.35, numberLetterSpacing: -0.5,
    labelTransform: 'uppercase',
    mood: 'ultra-minimal', isDark: false,
  },

  'slate-pro': {
    accent: '#818cf8', accent2: '#6ee7b7',
    text: '#f8fafc', muted: '#94a3b8',
    bg: '#0b0f1a', surface: '#141d2e',
    border: 'rgba(129,140,248,0.3)', divider: 'rgba(255,255,255,0.05)',
    positive: '#6ee7b7', negative: '#f87171',
    radius: 3, strokeWidth: 1.5,
    shadow: '0 4px 20px rgba(129,140,248,0.2)',
    fontHeading: '"DM Sans", Inter, system-ui, sans-serif',
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 600, fontWeightBody: 400,
    spacing: 1.15, numberLetterSpacing: -1.2,
    labelTransform: 'uppercase',
    mood: 'saas', isDark: true,
  },

  'emerald-fintech': {
    accent: '#059669', accent2: '#34d399',
    text: '#0a2218', muted: '#3d7a5c',
    bg: '#f0fdf4', surface: '#ffffff',
    border: '#bbf7d0', divider: '#d1fae5',
    ...
    spacing: 1.0, numberLetterSpacing: -0.25,
    labelTransform: 'none',
    mood: 'growth', isDark: false,
  },

  'midnight-tech': {
    accent: '#06b6d4', accent2: '#22d3ee',
    text: '#e2e8f0', muted: '#64748b',
    bg: '#03060c', surface: '#0d1117',
    border: 'rgba(6,182,212,0.22)', divider: 'rgba(6,182,212,0.07)',
    positive: '#22d3ee', negative: '#f87171',
    radius: 6, strokeWidth: 1,
    ...
    spacing: 1.05, numberLetterSpacing: -0.5,
    labelTransform: 'uppercase',
    mood: 'tech', isDark: true,
  },

  'rose-modern': {
    accent: '#f43f5e', accent2: '#fb7185',
    text: '#1f0a10', muted: '#9f4460',
    bg: '#fff1f3', surface: '#ffffff',
    border: '#fecdd3', divider: '#ffe4e6',
    positive: '#166534', negative: '#be123c',
    radius: 12, strokeWidth: 1,
    shadow: '0 4px 12px rgba(244,63,94,0.1)',
    fontHeading: 'Inter, system-ui, sans-serif',
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 700, fontWeightBody: 400,
    spacing: 1.05, numberLetterSpacing: -0.25,
    labelTransform: 'none',
    mood: 'warm', isDark: false,
  },

  'cobalt-impact': {
    accent: '#60a5fa', accent2: '#93c5fd',
    text: '#ffffff', muted: 'rgba(255,255,255,0.68)',
    bg: 'linear-gradient(150deg, #1e3a8a 0%, #1d4ed8 100%)',
    surface: 'rgba(255,255,255,0.1)',
    border: 'rgba(255,255,255,0.2)', divider: 'rgba(255,255,255,0.08)',
    positive: '#86efac', negative: '#fca5a5',
    radius: 10, strokeWidth: 1,
    ...
    spacing: 1.0, numberLetterSpacing: -0.5,
    labelTransform: 'none',
    mood: 'enterprise', isDark: true,
  },

  'warm-sand': {
    accent: '#92400e', accent2: '#b45309',
    text: '#1c0a00', muted: '#78350f',
    bg: '#fffbf3', surface: '#ffffff',
    border: '#fed7aa', divider: '#fef3c7',
    positive: '#166534', negative: '#b91c1c',
    radius: 8, strokeWidth: 1,
    shadow: 'none',
    fontHeading: '"Playfair Display", Georgia, serif',
    fontBody:    'Inter, system-ui, sans-serif',
    fontWeightHeading: 700, fontWeightBody: 400,
    spacing: 1.2, numberLetterSpacing: -0.5,
    labelTransform: 'uppercase',
    mood: 'lifestyle', isDark: false,
  },

  'violet-creative': {
    accent: '#a78bfa', accent2: '#c4b5fd',
    text: '#f3f0ff', muted: '#c4b5fd',
    bg: '#16102e', surface: '#1e1545',
    border: 'rgba(167,139,250,0.35)', divider: 'rgba(167,139,250,0.1)',
    positive: '#a3e635', negative: '#fb7185',
    radius: 12, strokeWidth: 1,
    ...
    spacing: 1.0, numberLetterSpacing: -0.5,
    labelTransform: 'none',
    mood: 'creative', isDark: true,
  },

  'teal-health': {
    accent: '#0d9488', accent2: '#14b8a6',
    text: '#0d2b28', muted: '#2d6b68',
    bg: '#f0fdfc', surface: '#ffffff',
    border: '#99f6e4', divider: '#ccfbf1',
    positive: '#16a34a', negative: '#dc2626',
    radius: 10, strokeWidth: 1,

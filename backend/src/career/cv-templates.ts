...
export const CV_TEMPLATE_LIBRARY: CvTemplateSeed[] = [
  ...
  T('cv', 'Executive Prestige', 'Executive', {
    ...
    premium: true,
    accentDividers: true,
    customCss: `/*executive-luxury-serif-gold-navy-spacious*/.sidebar{background:linear-gradient(175deg,#0D1B2A 0%,#14283E 100%)}.sidebar-head{border-bottom-color:rgba(141,116,35,.35)}.sidebar-head h1{font-size:26px;letter-spacing:-.01em;font-weight:500}.sidebar h2{color:rgba(141,116,35,.85);border-color:rgba(141,116,35,.3);font-size:10px;letter-spacing:.12em}.photo-circle{border:3px solid rgba(141,116,35,.45)}h2{color:#0D1B2A;border-color:#8D7423;font-size:13px;letter-spacing:.04em;font-weight:600}.e-role{font-weight:600;font-size:14px;color:#0F172A;font-style:italic;font-family:'Playfair Display',serif}.e-company{color:#8D7423;font-style:italic;font-weight:500}.e-date{color:#9CA3AF;font-style:italic;font-size:10px}.tl-dot{background:#8D7423;box-shadow:0 0 0 3px rgba(141,116,35,.25)}.tl-track{border-left-color:rgba(141,116,35,.35)}.sk-chip{border-left-color:#8D7423;background:rgba(141,116,35,.04)}.chip-name{color:#E6EDF3}.chip-level{color:#8D7423}.cert-item{border-left-color:#8D7423;background:rgba(141,116,35,.04)}.cert-name{color:#E6EDF3;font-size:11px;font-weight:600}.cert-issuer{color:#8D7423;font-size:10px}.e-bullets strong.metric{color:#8D7423;font-weight:700}.award-item{border-bottom:1px solid rgba(141,116,35,.15);padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:600;color:#0F172A;font-style:italic;font-family:'Playfair Display',serif}.award-meta{color:#8D7423;font-size:11px}`,
  }),
  ...
  T('resume', 'Modern Split', 'Modern', {
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*modern-dynamic-gradient*/.sidebar{background:#F0F9FF;border-right:1px solid #BAE6FD}.sidebar h2{color:#027DBD;border-color:#027DBD;opacity:1;font-size:10px;letter-spacing:.1em;font-weight:700}.sidebar .dots{color:#027DBD}.sidebar .pill{background:rgba(2,125,189,.12);color:#027DBD;font-weight:600}.sidebar .cert-item{border-left:3px solid #027DBD;padding-left:10px;margin-bottom:8px;background:rgba(2,125,189,.04)}.sidebar .cert-name{font-weight:700;font-size:10px}.sidebar .cert-issuer{color:#027DBD;font-size:9px}.photo-circle{border:3px solid #027DBD}h2{color:#027DBD;border-color:#027DBD;font-family:'DM Sans',sans-serif;font-weight:700;font-size:12px;letter-spacing:.06em}.header.block h1{font-size:38px;font-weight:700;letter-spacing:-.025em}.header.block .headline{color:#027DBD;font-weight:600;font-size:15px}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#027DBD;font-style:italic;font-weight:500}.e-date{color:#64748B;font-size:10px}.e-bullets strong.metric{color:#027DBD;font-weight:800}.award-item{border-bottom:1px solid #BAE6FD;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#027DBD;font-size:11px}`,
  }),
  ...
  T('cv', 'Modern Dark', 'Modern', {
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*modern-dynamic-gradient*/.sidebar{background:linear-gradient(175deg,#1E293B 0%,#0F172A 100%)}.sidebar-head h1{font-size:24px;font-weight:700}.sidebar h2{color:rgba(99,101,240,.9);border-color:rgba(99,101,240,.35);letter-spacing:.18em;font-family:'Plus Jakarta Sans',sans-serif;font-size:10px}.sidebar .dots{color:#818CF8}.sidebar .sk-compact-grid{gap:6px}.sidebar .sk-compact{font-size:10px;color:#E2E8F0}.sidebar .compact-dots{color:#818CF8}.sidebar .cert-item{border-left-color:#818CF8;background:rgba(99,101,240,.05)}.sidebar .cert-name{color:#E2E8F0;font-size:11px;font-weight:700}.sidebar .cert-issuer{color:#818CF8;font-size:10px}.photo-circle{border-color:rgba(99,101,240,.5);border-width:3px}h2{color:#4F46E5;border-color:#4F46E5;font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;font-size:12px;letter-spacing:.06em}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#4F46E5;font-style:italic;font-weight:500}.e-date{color:#64748B;font-size:10px}.e-bullets strong.metric{color:#6365F0;font-weight:800}.award-item{border-bottom:1px solid #E0E7FF;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#6365F0;font-size:11px}`,
  }),
  ...
  T('cv', 'Creative Dark', 'Creative', {
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*creative-bold-vivid-gradient-artistic*/.sidebar{background:linear-gradient(175deg,#0F172A 0%,#1a2538 100%)}.sidebar-head h1{font-size:26px;color:#947205;font-weight:700}.sidebar-head .s-headline{color:#94A3B8}.sidebar h2{color:#947205;border-color:rgba(148,114,5,.3);opacity:1;font-size:10px;letter-spacing:.1em}.sidebar .pill{background:rgba(148,114,5,.15);color:#947205;font-weight:600}.sidebar .sk-chip{border-left-color:#947205;background:rgba(148,114,5,.08)}.sidebar .chip-name{color:#E6EDF3}.sidebar .chip-level{color:#947205}.sidebar .cert-item{border-left-color:#947205;background:rgba(148,114,5,.05)}.sidebar .cert-name{color:#E6EDF3;font-size:11px;font-weight:700}.sidebar .cert-issuer{color:#947205;font-size:10px}.photo-circle{border:3px solid rgba(148,114,5,.5)}h2{color:#947205;border-color:rgba(148,114,5,.5);font-size:12px;letter-spacing:.05em;font-weight:700}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#D97706;font-style:italic;font-weight:500}.e-date{color:#6B7280;font-size:10px}.e-bullets strong.metric{color:#947205;font-weight:800}.award-item{border-bottom:1px solid rgba(148,114,5,.15);padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#D97706;font-size:11px}`,
  }),
  ...
  T('cv', 'Creative Coral', 'Creative', {
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*creative-bold-vivid-gradient-artistic*/.sidebar{background:linear-gradient(160deg,#CD4D0B 0%,#C2410C 100%)}.sidebar-head h1{font-size:25px;font-weight:700}.sidebar h2{color:rgba(255,255,255,.7);border-color:rgba(255,255,255,.25);font-size:10px;letter-spacing:.1em}.sidebar .bar{background:rgba(255,255,255,.2)}.sidebar .fill{background:#FFF}.sidebar .dots{color:#FFF}.sidebar .cert-item{border-left:3px solid rgba(255,255,255,.6);padding-left:10px;margin-bottom:8px;background:rgba(255,255,255,.08)}.sidebar .cert-name{color:#FFF;font-size:11px;font-weight:700}.sidebar .cert-issuer{color:rgba(255,255,255,.8);font-size:10px}.photo-circle{border-color:rgba(255,255,255,.5);border-width:3px}h2{color:#CD4D0B;border-color:#CD4D0B;font-size:12px;letter-spacing:.05em;font-weight:700}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#C2410C;font-style:italic;font-weight:500}.e-date{color:#6B7280;font-size:10px}.pill{background:rgba(205,77,11,.1);color:#CD4D0B;font-weight:600;font-size:10px}.e-bullets strong.metric{color:#CD4D0B;font-weight:800}.award-item{border-bottom:1px solid #FED7AA;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#C2410C;font-size:11px}`,
  }),
  ...
  T('cv', 'Dev Terminal', 'Developer', {
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*developer-monospace-terminal-technical-green*/.sidebar{background:#0D1117;font-family:'JetBrains Mono',monospace}.sidebar-head h1{font-family:'JetBrains Mono',monospace;font-size:20px;color:#E6EDF3}.sidebar-head .s-headline{color:#8B949E;font-size:11px}.sidebar-head{border-bottom-color:rgba(18,136,62,.3)}.sidebar h2{font-family:'JetBrains Mono',monospace;color:#12883E;border-color:rgba(18,136,62,.25);border-bottom-width:1px}.sidebar h2::before{content:'// '}.sidebar .pill{background:transparent;border:1px solid #12883E;color:#12883E;font-family:'JetBrains Mono',monospace;border-radius:2px;font-size:9.5px}.sidebar .sk-compact-grid{gap:6px 10px}.sidebar .sk-compact{font-family:'JetBrains Mono',monospace;font-size:10px}.sidebar .compact-dots{color:#12883E;font-size:11px}.c-ico{color:#12883E}h2{color:#12883E;border-color:#12883E;font-family:'JetBrains Mono',monospace;border-bottom-width:1px}h2::before{content:'// ';color:#12883E;opacity:.5;font-size:11px}.e-role{font-family:'JetBrains Mono',monospace;font-size:12.5px;font-weight:700}.e-company{color:#12883E;font-family:'JetBrains Mono',monospace;font-size:11px;font-style:normal}.e-date{font-family:'JetBrains Mono',monospace;font-size:10px;color:#6B7280}.pill{background:transparent;border:1px solid rgba(18,136,62,.4);color:#12883E;font-family:'JetBrains Mono',monospace;border-radius:2px}.cert-item{border-left-color:#12883E;background:rgba(18,136,62,.04)}.cert-name{color:#E6EDF3;font-family:'JetBrains Mono',monospace;font-size:11px}.cert-issuer{color:#12883E;font-family:'JetBrains Mono',monospace}`,
  }),
  ...
  T('resume', 'Dev Data', 'Developer', {
    ...
    photoShape: 'circle',
    photoPlace: 'header',
    customCss: `/*developer-monospace-terminal-technical-green*/.header.minimal h1{font-family:'JetBrains Mono',monospace;font-size:38px;font-weight:700;letter-spacing:-.02em}.header.minimal .headline{font-size:12px;letter-spacing:.06em;color:#6365F0;text-transform:uppercase;font-weight:500;font-family:'JetBrains Mono',monospace}.header.minimal .contact-bar{color:#6B7280;font-family:'JetBrains Mono',monospace;font-size:10px}.header.minimal{border-bottom-color:#E0E7FF;border-bottom-width:2px}h2{font-family:'JetBrains Mono',monospace;font-size:10px;color:#6365F0;border-color:#C7D2FE;font-weight:700;letter-spacing:.1em}h2::before{content:'>>> ';color:#6365F0;opacity:.6}.e-role{font-family:'JetBrains Mono',monospace;font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#4F46E5;font-family:'JetBrains Mono',monospace;font-size:12px;font-style:normal;font-weight:500}.e-date{font-family:'JetBrains Mono',monospace;font-size:10px;color:#6B7280}.pill{background:rgba(99,101,240,.1);color:#4F46E5;font-family:'JetBrains Mono',monospace;font-size:10px;font-weight:600}.e-bullets strong.metric{color:#6365F0;font-weight:800}.cert-item{border-left:3px solid #6365F0;padding-left:12px;margin-bottom:10px;background:rgba(99,101,240,.03)}.cert-name{font-weight:700;font-size:12px;font-family:'JetBrains Mono',monospace}.cert-issuer{color:#4F46E5;font-size:10px}.cert-date{color:#6B7280;font-size:9px}.award-item{border-bottom:1px solid #C7D2FE;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;font-family:'JetBrains Mono',monospace}.award-meta{color:#4F46E5;font-size:11px}`,
  }),
  ...
  T('cv', 'Startup Founder', 'Startup', {
    ...
    accent: '#05875F',
    headerStyle: 'banner',
    headerBg: 'linear-gradient(135deg,#05875F 0%,#047857 100%)',
    typography: { heading: 'Poppins', body: 'Inter' },
    density: 'comfortable',
    style: 'banner',
    skillStyle: 'compact',
    ...
    premium: true,
    accentDividers: true,
    customCss: `/*startup-growth-dynamic-modern-energetic*/.banner-text h1{font-size:42px;font-weight:800;letter-spacing:-.03em}.banner-text .headline{font-size:17px;font-weight:500;opacity:.9}h2{border-bottom:none;color:#05875F;padding-bottom:0;font-family:'Poppins',sans-serif;font-weight:700}h2::after{content:'';display:block;width:36px;height:3px;background:#05875F;border-radius:2px;margin-top:7px}.e-role{font-weight:700;color:#0F172A}.e-company{color:#05875F;font-style:italic;font-weight:400}.e-date{color:#64748B;font-size:10px}.tl-dot{background:#05875F;box-shadow:0 0 0 3px #A7F3D0}.tl-track{border-left-color:#A7F3D0}.pill{background:rgba(5,135,95,.1);color:#05875F;font-weight:600}.e-bullets strong.metric{color:#047857;font-weight:800;font-size:11.5px}.cert-item{border-left-color:#05875F;background:rgba(5,135,95,.03)}.cert-name{font-weight:800}.award-item{border-bottom-color:rgba(5,135,95,.15)}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#05875F;font-weight:500}`,
  }),
  ...
  T('resume', 'Startup Growth', 'Startup', {
    ...
    accent: '#B36205',
    headerStyle: 'banner',
    headerBg: 'linear-gradient(135deg,#B36205 0%,#B45309 100%)',
    typography: { heading: 'Poppins', body: 'Inter' },
    density: 'compact',
    style: 'banner',
    skillStyle: 'compact',
    ...
    photoShape: 'circle',
    photoPlace: 'header',
    customCss: `/*startup-growth-dynamic-modern-energetic*/.banner-text h1{font-size:44px;font-weight:800;letter-spacing:-.03em}.banner-text .headline{font-size:16px;font-weight:600;opacity:.92}h2{border-bottom:none;color:#B45309;padding-bottom:0;font-family:'Poppins',sans-serif;font-weight:700;font-size:11px;letter-spacing:.06em}h2::after{content:'';display:block;width:28px;height:3px;background:#B36205;border-radius:2px;margin-top:6px}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#B45309;font-style:italic;font-weight:500}.e-date{color:#64748B;font-size:10px}.pill{background:rgba(179,98,5,.1);color:#B45309;font-weight:600;font-size:10px}.e-bullets strong.metric{color:#B36205;font-weight:800}.cert-item{border-left:3px solid #B36205;padding-left:12px;margin-bottom:10px;background:rgba(179,98,5,.03)}.cert-name{font-weight:800;color:#0F172A;font-size:12px}.cert-issuer{color:#B45309;font-size:10px}.cert-date{color:#64748B;font-size:9px}.award-item{border-bottom:1px solid #FED7AA;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#B36205;font-size:11px;font-weight:500}`,
  }),
  ...
  T('cv', 'Startup PM', 'Startup', {
    ...
    accent: '#027DBD',
    headerStyle: 'banner',
    headerBg: 'linear-gradient(135deg,#027DBD 0%,#0369A1 100%)',
    ...
    timeline: true,
    accentDividers: true,
    customCss: `/*startup-growth-dynamic-modern-energetic*/.sidebar{background:#F0F9FF;border-left:1px solid #BAE6FD}.sidebar-head h1{font-size:24px;letter-spacing:-.02em}.sidebar h2{color:#027DBD;border-color:#027DBD;opacity:1;font-size:10px;font-family:'Manrope',sans-serif;font-weight:700;letter-spacing:.1em}.sidebar .pill{background:rgba(2,125,189,.12);color:#027DBD;font-weight:600}.sidebar .dots{color:#027DBD}.sidebar .cert-item{border-left:3px solid #027DBD;padding-left:10px;margin-bottom:8px;background:rgba(2,125,189,.04)}.sidebar .cert-name{font-weight:700;font-size:10px}.sidebar .cert-issuer{color:#027DBD;font-size:9px}.banner-text h1{font-size:38px;font-weight:800;letter-spacing:-.02em}.banner-text .headline{font-size:16px;font-weight:600;opacity:.95}h2{color:#027DBD;border-color:#027DBD;font-family:'Manrope',sans-serif;font-weight:700;font-size:11px;letter-spacing:.06em}.e-role{font-weight:700;color:#0F172A;font-size:14px}.e-company{color:#027DBD;font-style:italic;font-weight:500}.e-date{color:#64748B;font-size:10px}.pill{background:rgba(2,125,189,.1);color:#027DBD;font-size:10px}.e-bullets strong.metric{color:#027DBD;font-weight:800}.award-item{border-bottom:1px solid #BAE6FD;padding-bottom:8px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:baseline}.award-name{font-weight:700;color:#0F172A}.award-meta{color:#027DBD;font-size:11px;font-weight:500}`,
  }),
  ...
  T('coverLetter', 'Cover Letter Classic', 'Corporate', {
    columns: 1,
    accent: '#1F2937',
    headerStyle: 'block',
    typography: { heading: 'Inter', body: 'Inter' },
  ...
  T('coverLetter', 'Cover Letter Executive', 'Executive', {
    columns: 1,
    accent: '#0D1B2A',
    headerStyle: 'block',
    typography: { heading: 'Playfair Display', body: 'Lora' },
  ...
  T('coverLetter', 'Cover Letter Modern', 'Modern', {
    columns: 1,
    accent: '#4F46E5',
    headerStyle: 'banner',
    typography: { heading: 'DM Sans', body: 'DM Sans' },
  ...
  T('coverLetter', 'Cover Letter Creative', 'Creative', {
    columns: 1,
    accent: '#7C3AED',
    headerStyle: 'banner',
    typography: { heading: 'Poppins', body: 'Inter' },
  ...
  T('coverLetter', 'Cover Letter Developer', 'Developer', {
    columns: 1,
    accent: '#12883E',
    headerStyle: 'minimal',
    typography: { heading: 'JetBrains Mono', body: 'Inter' },
  ...
  T('coverLetter', 'Cover Letter Consultant', 'Consultant', {
    columns: 1,
    accent: '#1E3A8A',
    headerStyle: 'block',
    typography: { heading: 'DM Serif Display', body: 'DM Sans' },
  ...
  T('coverLetter', 'Cover Letter Academic', 'Academic', {
    columns: 1,
    accent: '#1F2937',
    headerStyle: 'block',
    typography: { heading: 'Lora', body: 'Lora' },
  ...
  // Ω.PRODUCT.2A — differentiated from "Cover Letter Executive": two-column
  // banner portfolio, deep terracotta accent, Cormorant/Manrope pairing.
  T('portfolio', 'Portfolio Executive', 'Executive', {
    columns: 2,
    accent: '#7C2D12',
    headerStyle: 'banner',
  ...
  T('portfolio', 'Portfolio Creative', 'Creative', {
    columns: 2,
    accent: '#7C3AED',
    headerStyle: 'banner',
    typography: { heading: 'Poppins', body: 'Inter' },
  ...
  T('portfolio', 'Portfolio Developer', 'Developer', {
    columns: 1,
    accent: '#12883E',
    headerStyle: 'block',
    typography: { heading: 'JetBrains Mono', body: 'Inter' },
  ...
  // Ω.PRODUCT.2A — differentiated from "Designer Editorial": gallery-style split
  // header, teal accent, modern grotesque type, tighter rhythm.
  T('portfolio', 'Portfolio Designer', 'Designer', {
    columns: 2,
    accent: '#0F766E',
    headerStyle: 'split',
  ...
  T('portfolio', 'Portfolio Minimal', 'Academic', {
    columns: 1,
    accent: '#1F2937',
    headerStyle: 'minimal',
    typography: { heading: 'DM Sans', body: 'DM Sans' },

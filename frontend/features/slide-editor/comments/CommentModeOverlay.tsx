...
export const CommentModeOverlay: React.FC<Props> = ({ active, elements, onCancel, onSubmit }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-1/2 -translate-x-1/2 flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#D9A441] text-white text-xs font-semibold shadow-lg pointer-events-none">
      ...
      {pending && (
        ...
        >
          ...
          <div
            className="absolute -left-[26px] -top-[26px] w-6 h-6 rounded-full bg-[#D9A441] ring-2 ring-white shadow-lg flex items-center justify-center text-white pointer-events-none"
          >
            <MessageSquare className="w-3 h-3" />
          </div>

          {pending.elementId && (
            <div className="text-[10px] uppercase tracking-wide text-[#735008] font-bold mb-1">
              Attached to element
            </div>
          )}
          ...
          <textarea
            ...
            rows={3}
            className="w-full text-sm border border-[#E3E1DA] rounded p-2 resize-none focus:outline-none focus:ring-2 focus:ring-amber-300"
          />
          ...
          <div className="mt-2 flex items-center justify-end gap-1.5">
            <button
              ...
              className="px-2 py-1 text-xs text-[#6B6B6B] hover:bg-[#F1F0EC] rounded inline-flex items-center gap-1"
            >
            ...
            <button
              ...
              className="px-3 py-1 text-xs font-semibold text-white bg-[#D9A441] hover:bg-amber-600 rounded disabled:opacity-40 disabled:cursor-not-allowed"
            >

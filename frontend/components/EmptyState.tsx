    ...
    >
      ...
      {action && (
        <motion.button
          ...
          className="rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-3 text-sm font-medium text-white shadow-lg transition-shadow hover:shadow-xl"
        >
          {action.label}
        </motion.button>
      )}

    ...
    <div className={`w-full ${className}`}>
      ...
      {uploadedUrl && previewUrl && (
        <div className="relative rounded-2xl overflow-hidden border-2 border-green-500">
          ...
          <div className="absolute top-4 right-4 flex space-x-2">
            <div className="bg-green-600 text-white rounded-full px-4 py-2 flex items-center space-x-2">
      ...
      {error && (
        <div className="mt-4 bg-red-50 border border-red-200 rounded-xl p-4">
          ...
          <button
            onClick={handleReset}
            className="text-red-700 text-sm font-semibold mt-2 hover:underline"
          >
            Try again
          </button>
        </div>
